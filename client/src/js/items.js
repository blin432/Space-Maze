...
export const items = [ 
    {img:Rock,
    description:"You don't need a rocket scientist to tell you that you can't move through space rocks."},
    {img:Flag,
    description: "The waving checkered flag marks the finish line for each level."},
    {img:Wormhole,
